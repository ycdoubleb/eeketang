                            ...
                            <div class="tabcontent">
                                <div id="diat-1" class="tabpane show">
                                    <div class="resource diat">
                                        ...
                                        <?= Html::a('<div class="elem-hover">' . Html::img(['/filedata/site/image/icon_8_1.png']) . '</div>', ['/study/api/join-college', 'cate_id' => 10]) ?>
                                    </div>
                                    <div class="resource diat">
                                        <img src="/filedata/site/image/image_3_2.jpg" width="100%">
                                        <?= Html::a('<div class="elem-hover">' . Html::img(['/filedata/site/image/icon_8_1.png']) . '</div>', ['/study/api/join-college', 'cate_id' => 11]) ?>
                                    </div>
                                    <div class="resource diat">
                                        <img src="/filedata/site/image/image_3_3.jpg" width="100%">
                                        <?= Html::a('<div class="elem-hover">' . Html::img(['/filedata/site/image/icon_8_1.png']) . '</div>', ['/study/api/join-college', 'cate_id' => 12]) ?>
                                    </div>
                                    <div class="resource diat none">
                                        <img src="/filedata/site/image/image_3_4.jpg" width="100%">
                                        <?= Html::a('<div class="elem-hover">' . Html::img(['/filedata/site/image/icon_8_1.png']) . '</div>', ['/study/api/join-college', 'cate_id' => 13]) ?>
                                    </div>
                                </div>
                                <div id="diat-2" class="tabpane">
                                    <div class="resource diat">
                                        <img src="/filedata/site/image/image_3_5.jpg" width="100%">
                                        <?= Html::a('<div class="elem-hover">' . Html::img(['/filedata/site/image/icon_8_1.png']) . '</div>', ['/study/api/join-college', 'cate_id' => 14]) ?>
                                    </div>
                                    <div class="resource diat">
                                        <img src="/filedata/site/image/image_3_6.jpg" width="100%">
                                        <?= Html::a('<div class="elem-hover">' . Html::img(['/filedata/site/image/icon_8_1.png']) . '</div>', ['/study/api/join-college', 'cate_id' => 15]) ?>
                                    </div>
                                    <div class="resource diat">
                                        <img src="/filedata/site/image/image_3_7.jpg" width="100%">
                                        <?= Html::a('<div class="elem-hover">' . Html::img(['/filedata/site/image/icon_8_1.png']) . '</div>', ['/study/api/join-college', 'cate_id' => 16]) ?>
                                    </div>
                                    <div class="resource diat none">
                                        <img src="/filedata/site/image/image_3_8.jpg" width="100%">
                                        <?= Html::a('<div class="elem-hover">' . Html::img(['/filedata/site/image/icon_8_1.png']) . '</div>', ['/study/api/join-college', 'cate_id' => 17]) ?>
                                    </div>
                                </div>
                            </div>
                        </div>
