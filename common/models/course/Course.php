...
class Course extends ActiveRecord
{
    ...
    //年级
    public static $grade_keys = [0=>'幼儿圆',1=>'一年级',2=>'二年级',3=>'三年级',4=>'四年级',5=>'五年级',6=>'六年级',7=>'七年级',8=>'八年级',9=>'九年级',10=>'高一',11=>'高二',12=>'高三'];
    //学期、册数
    public static $term_keys = [0=>'默认',1=>'上册',2=>'下册',3=>'全一册'];
    //课程教材logo
    public static $tm_logo =['人教版'=>'01','广州版'=>'02','牛津上海版'=>'03','粤教版'=>'04'];
    //课程图片的背景颜色
