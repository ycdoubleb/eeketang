 ...
 * @property string $real_name  真实名称，等于nickname
...
class User extends ActiveRecord implements IdentityInterface {
    ...
    public function rules() {
        return [
            ...
            [['username', 'nickname'], 'required', 'on' => [self::SCENARIO_CREATE, self::SCENARIO_UPDATE]],
            [['username'], 'unique'],
            [['password'], 'string', 'min' => 6, 'max' => 64],
            [['username'], 'string', 'max' => 36, 'on' => [self::SCENARIO_CREATE]],
            [['id', 'username', 'real_name', 'password', 'password_reset_token', 'email', 'avatar',], 'string', 'max' => 255],
            [['sex'], 'integer'],
